...
const Register = ({ setIsAuthenticated }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: 'expert', // Default to expert for Enterprise Expert registration
    acceptTerms: false,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Assign badge and authenticate
      alert('Registration successful! Welcome to SynapMentor Enterprise. Verification email sent.')
