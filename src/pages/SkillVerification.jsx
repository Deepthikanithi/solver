      ...
      <div className="relative p-6 space-y-6 min-h-screen">
        ...
        onMouseLeave={(e) => {
          ...
          <div className={`w-24 h-24 mx-auto mb-6 rounded-full flex items-center justify-center ${
            ...
            <svg className={`w-12 h-12 ${darkMode ? 'text-white' : 'text-[#00001a]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          onMouseEnter={(e) => {
            if (darkMode) {
              e.currentTarget.style.boxShadow = '0 0 12px rgba(255, 255, 255, 0.15), 0 0 25px rgba(255, 255, 255, 0.08), 0 4px 12px rgba(0, 0, 0, 0.15)';
            } else {
              e.currentTarget.style.boxShadow = '0 0 10px rgba(0, 0, 26, 0.3), 0 0 20px rgba(0, 0, 26, 0.12), 0 4px 10px rgba(0, 0, 0, 0.1)';
            }
          }}
          onMouseLeave={(e) => {
            if (darkMode) {
            ...
            <div className="space-y-2 text-left">
              <div className="flex items-center">
                <svg className={`w-5 h-5 mr-3 ${darkMode ? 'text-white' : 'text-[#00001a]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
