            ...
            <div key={level.id} className="flex items-center flex-1">
                ...
                <div className={`w-12 h-12 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${
                  isCompleted
                    ? darkMode
                      ...
                      : 'bg-[#00001a]/10 text-[#00001a] border-2 border-[#00001a]/30'
                    : isCurrent
                      ? darkMode
                      ...
                      : isAccessible
                        ? darkMode
                          ...
                          : 'bg-[#00001a]/5 text-[#00001a]/60 border-2 border-[#00001a]/20'
                        : darkMode
                          ? 'bg-white/5 text-white/40 border-2 border-white/10'
                          : 'bg-[#00001a]/3 text-[#00001a]/40 border-2 border-[#00001a]/10'
                }`}>
                  {isCompleted ? <Check size={20} /> : level.step}
                </div>
              ...
              {index < verificationLevels.length - 1 && (
                <div className={`flex-1 h-0.5 mx-4 transition-all duration-300 ${
                  isCompleted
                    ? darkMode ? 'bg-white/50' : 'bg-[#00001a]/30'
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div
                ...
                className={`group p-6 backdrop-blur-xl border transition-all duration-500 shadow-xl relative overflow-hidden ${
                  ...
                  isLevelCompleted('light')
                    ? darkMode
                      ? 'rounded-lg bg-green-500/10 border-green-500/30'
                      : 'rounded-lg bg-[#00001a]/10 border-[#00001a]/30'
                    : currentVerificationLevel === 'light'
                      ? darkMode
                        ? 'rounded-lg bg-white/10 border-white/30'
                        : 'rounded-lg bg-[#00001a]/10 border-[#00001a]/30'
                      : darkMode
                    ...
                    : currentVerificationLevel === 'standard'
                      ...
                      : isLevelAccessible('standard')
                        ? darkMode
                          ...
                          : 'rounded-lg bg-white border-[#00001a]/20'
                        : darkMode
                          ? 'rounded-lg bg-white/3 border-white/10'
                          : 'rounded-lg bg-[#00001a]/5 border-[#00001a]/20'
                }`}
                style={darkMode ? {
                  boxShadow: '0 2px 8px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1)',
                  transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  if (darkMode) {
                    e.currentTarget.style.boxShadow = '0 0 20px rgba(255, 255, 255, 0.15), 0 2px 8px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.2)';
                  } else {
                    e.currentTarget.style.boxShadow = '0 6px 16px rgba(0, 0, 26, 0.2)';
                  }
                }}
                onMouseLeave={(e) => {
                  if (darkMode) {
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className={`p-6 rounded-lg border ${
                    darkMode ? 'bg-white/5 border-white/10' : 'bg-[#00001a]/5 border-[#00001a]/20'
                  }`}>
