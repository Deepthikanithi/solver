    ...
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      <div className="p-4 space-y-6">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3 mb-4">
              ...
              <div className={`group p-4 backdrop-blur-sm border transition-all duration-500 cursor-pointer ${
                darkMode ? 'rounded-lg bg-white/3 border-white/20 hover:bg-white/8 hover:border-white/30' : 'rounded-xl bg-gradient-to-br from-white/50 via-white/40 to-white/30 border-white/30'
              }`}
              style={darkMode ? {
                boxShadow: '0 2px 8px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1)',
                transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
              ...
              onMouseLeave={(e) => {
                ...
                <div className={`text-lg font-bold ${darkMode ? 'text-yellow-400' : 'text-yellow-600'}`}>🏆 Gold</div>
              ...
              onMouseLeave={(e) => {
                ...
                <div className={`text-xs font-medium mb-2 ${darkMode ? 'text-white/70' : 'text-[#00001a]/70'}`}>Total Sessions</div>
                <div className={`text-lg font-bold ${darkMode ? 'text-white' : 'text-[#00001a]'}`}>23</div>
                <div className={`text-xs ${darkMode ? 'text-white/50' : 'text-[#00001a]/50'}`}>Completed</div>
              </div>
              ...
              onMouseLeave={(e) => {
                ...
                <div className={`text-lg font-bold ${darkMode ? 'text-pink-400' : 'text-pink-600'}`}>📈</div>
        ...
        <div className={`group p-8 backdrop-blur-xl border transition-all duration-500 shadow-xl relative overflow-hidden cursor-pointer ${
          darkMode
            ? 'rounded-lg bg-white/3 border-white/20 hover:bg-white/8 hover:border-white/30'
            : 'rounded-2xl bg-gradient-to-br from-white/50 via-white/40 to-white/30 border-white/30 shadow-black/10'
        }`}
        style={darkMode ? {
          boxShadow: '0 2px 8px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1)',
          transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={user.rank} className={`flex items-center justify-between p-4 rounded-xl backdrop-blur-sm border transition-all duration-500 cursor-pointer ${
                  user.name.includes('You')
                    ? darkMode ? 'bg-blue-500/15 border-blue-500/30 hover:bg-blue-500/25 hover:border-blue-500/40' : 'bg-blue-100/60 border-blue-200'
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5">
                {recentEarnings.map((earning, index) => (
                  <div key={index} className={`flex items-center justify-between p-5 rounded-xl backdrop-blur-sm border transition-all duration-500 cursor-pointer ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className={`group rounded-2xl p-3 backdrop-blur-xl border transition-all duration-500 shadow-xl relative overflow-hidden cursor-pointer ${
            darkMode
                      ...
                      day
                        ? isSelected
                          ? darkMode
                            ...
                            : 'bg-blue-300 text-blue-900 border border-blue-400'
                          : isToday
                            ? darkMode
                            ...
                            : hasBookings
                              ? darkMode
                                ...
                                : 'text-gray-900 hover:bg-gray-100 font-semibold bg-red-100 border border-red-200'
                              : hasSlots
                                ? darkMode
                                  ? 'text-white hover:bg-white/10 font-semibold bg-green-500/20 border border-green-500/30'
                                  : 'text-gray-900 hover:bg-gray-100 font-semibold bg-green-100 border border-green-200'
                                : darkMode
            ...
            {selectedDay && (
              <div className="mt-6 pt-6 border-t border-gray-200/20">
                ...
                <div className="mt-4 flex flex-wrap gap-4 text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    <div className={`w-3 h-3 rounded-full ${darkMode ? 'bg-white/20' : 'bg-gray-300'}`}></div>
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={index} className={`p-3 rounded-xl border backdrop-blur-sm transition-all duration-500 cursor-pointer ${
                ...
                onMouseLeave={(e) => {
                  ...
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`px-3 py-1 text-xs rounded-xl backdrop-blur-sm border font-semibold ${
                      session.difficulty === 'Beginner'
                        ? darkMode ? 'bg-green-500/15 text-green-400 border-green-500/30' : 'bg-green-100 text-green-700 border-green-200'
                        : session.difficulty === 'Intermediate'
                        ? darkMode ? 'bg-yellow-500/15 text-yellow-400 border-yellow-500/30' : 'bg-yellow-100 text-yellow-700 border-yellow-200'
                        : darkMode ? 'bg-red-500/15 text-red-400 border-red-500/30' : 'bg-red-100 text-red-700 border-red-200'
                    }`}>
                      {session.difficulty}
                    </span>
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className={`group rounded-2xl p-5 backdrop-blur-xl border transition-all duration-500 shadow-xl relative overflow-hidden cursor-pointer ${
            darkMode
              ? 'bg-white/3 border-white/10 hover:bg-white/8 hover:border-white/20'
              : 'bg-white border-gray-200'
          }`}
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className={`p-6 rounded-xl border backdrop-blur-sm transition-all duration-500 cursor-pointer ${
                    darkMode ? 'bg-white/3 border-white/10 hover:bg-white/8 hover:border-white/20' : 'bg-white/40 border-gray-200/50'
                  }`}
                  style={darkMode ? {
                    boxShadow: '0 2px 10px rgba(0, 0, 0, 0.05)',
                  ...
                  onMouseLeave={(e) => {
                    ...
                    <div className="flex items-start space-x-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-sm font-bold backdrop-blur-sm border ${
                        darkMode ? 'bg-blue-500/15 text-blue-400 border-blue-500/30' : 'bg-blue-100 text-blue-700 border-blue-200'
                      }`}>
                        {session.avatar}
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="flex space-x-3">
                          <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 text-sm rounded-xl transition-all duration-300 backdrop-blur-sm border font-semibold ${
                              darkMode
                          ...
                          <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 text-sm rounded-xl transition-all duration-300 backdrop-blur-sm border font-semibold ${
                              darkMode
                                ...
                                : 'bg-white/40 text-gray-600 border-gray-200 hover:bg-white/60'
                            }`}>
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {expertiseData.domains.map((domain, index) => (
                      <span key={index} className={`px-4 py-2 rounded-xl text-sm backdrop-blur-md border transition-all duration-300 cursor-pointer ${
                        darkMode
        ...
        {/* Schedule Component */}
        <div className={`group rounded-2xl p-8 backdrop-blur-xl border transition-all duration-500 shadow-xl relative overflow-hidden cursor-pointer ${
          darkMode
            ? 'bg-white/3 border-white/10 hover:bg-white/8 hover:border-white/20'
            : 'bg-white border-gray-200'
        }`}
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className={`flex items-center space-x-4 p-4 rounded-xl backdrop-blur-sm border transition-all duration-300 cursor-pointer ${
                      darkMode ? 'bg-white/3 border-white/10 hover:bg-white/8 hover:border-white/20' : 'bg-white/40 border-white/30'
                    }`}
                    style={darkMode ? {
                      transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)'
                ...
                <div className="space-y-3">
                  {[
                    ...
                    style={darkMode ? {
                      ...
                      <div className={`w-3 h-3 rounded-full ${
                        item.type === 'session' ? 'bg-blue-500' :
                        item.type === 'break' ? 'bg-gray-500' : 'bg-orange-500'
                      }`}></div>
                      <div className="flex-1">
                        <div className={`text-sm font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>{item.title}</div>
                        <div className={`text-xs ${darkMode ? 'text-white/60' : 'text-gray-500'}`}>{item.time}</div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex space-x-2 mb-4">
              {['Active Requests', 'My Solutions', 'Completed'].map((tab, index) => (
                <button key={tab} className={`px-4 py-3 text-sm rounded-xl transition-all duration-300 backdrop-blur-sm border font-semibold ${
                  index === 0
                    ? darkMode
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={doubt.id} className={`p-6 rounded-xl border backdrop-blur-sm transition-all duration-500 cursor-pointer ${
                  darkMode ? 'bg-white/3 border-white/10 hover:bg-white/8 hover:border-white/20' : 'bg-white/40 border-gray-200/50'
                }`}
                style={darkMode ? {
                  boxShadow: '0 2px 10px rgba(0, 0, 0, 0.05)',
          ...
          onMouseLeave={(e) => {
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <button
                  onClick={handleCreateTutorial}
                  className={`px-6 py-3 rounded-xl backdrop-blur-md transition-all duration-300 border shadow-lg font-semibold ${
                    darkMode
