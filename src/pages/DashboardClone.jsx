...
const DashboardClone = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <div className="min-h-screen flex" style={{
      background: darkMode
        ? 'linear-gradient(135deg, #00001a 0%, #000033 50%, #00001a 100%)'
      ...
      <div className="w-64 flex flex-col relative z-10" style={{
        ...
        <div className="flex-1 p-4">
          ...
          {/* Tools Section */}
          <div className="mt-8">
            <h3 className="px-3 text-xs font-semibold uppercase tracking-wider mb-3" style={{
        ...
        <div className="p-4" style={{
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-1 transition-colors hover:scale-105"
              style={{
                color: darkMode ? '#9ca3af' : '#6b7280'
              }}
            >
      ...
      <div className="flex-1 flex flex-col relative z-10">
        {/* Top Header */}
        <header className="px-6 py-4 backdrop-blur-xl" style={{
          background: darkMode
            ? 'rgba(255, 255, 255, 0.05)'
        ...
        <main className="flex-1 p-6">
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: darkMode
                      ...
                      : '0 8px 32px rgba(37, 99, 235, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
                    color: '#ffffff'
                  }}
                >
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* Active Sessions - ENHANCED GLASSMORPHISM */}
            <div className="rounded-lg p-4 backdrop-blur-xl hover:scale-105 transition-all duration-300" style={{
              background: darkMode
                ? 'rgba(255, 255, 255, 0.15)'
                : 'rgba(255, 255, 255, 0.95)',
              border: darkMode
              ...
              <div className="flex flex-col items-center justify-center py-8">
                <MessageCircle className="w-10 h-10 mb-3" style={{
            ...
            {/* Recent Earnings - ENHANCED GLASSMORPHISM */}
            <div className="rounded-lg p-4 backdrop-blur-xl hover:scale-105 transition-all duration-300" style={{
              background: darkMode
                ? 'rgba(255, 255, 255, 0.15)'
                : 'rgba(255, 255, 255, 0.95)',
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            {/* Upcoming Sessions - ENHANCED GLASSMORPHISM */}
            <div className="rounded-lg p-4 backdrop-blur-xl hover:scale-105 transition-all duration-300" style={{
              background: darkMode
                ? 'rgba(255, 255, 255, 0.15)'
                : 'rgba(255, 255, 255, 0.95)',
              ...
              <div className="flex flex-col items-center justify-center py-8">
                <Calendar className="w-10 h-10 mb-3" style={{
                  color: darkMode ? '#6b7280' : '#d1d5db'
                }} />
                <h4 className="text-base font-medium mb-1" style={{
                  color: darkMode ? '#ffffff' : '#1f2937'
            ...
            {/* Expert Profile - ENHANCED GLASSMORPHISM */}
            <div className="rounded-lg p-4 backdrop-blur-xl hover:scale-105 transition-all duration-300" style={{
              background: darkMode
                ? 'rgba(255, 255, 255, 0.15)'
                : 'rgba(255, 255, 255, 0.95)',
          ...
          {/* Your Content Section - ENHANCED GLASSMORPHISM */}
          <div className="mt-4 rounded-lg p-4 backdrop-blur-xl hover:scale-105 transition-all duration-300" style={{
            background: darkMode
              ? 'rgba(255, 255, 255, 0.15)'
              : 'rgba(255, 255, 255, 0.95)',
            border: darkMode
            ...
            <div className="flex flex-col items-center justify-center py-8">
              <FileText className="w-10 h-10 mb-3" style={{
                color: darkMode ? '#6b7280' : '#d1d5db'
              }} />
              <h4 className="text-base font-medium mb-1" style={{
                color: darkMode ? '#ffffff' : '#1f2937'
          ...
          {/* Success Message - ENHANCED GLASSMORPHISM */}
          <div className="mt-4 rounded-lg p-3 backdrop-blur-xl hover:scale-105 transition-all duration-300" style={{
            background: darkMode
              ? 'rgba(34, 197, 94, 0.2)'
              : 'rgba(34, 197, 94, 0.15)',
            border: darkMode
