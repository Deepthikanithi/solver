...
const ReviewSessions = ({ darkMode }) => {
  ...
  const getStatusColor = (status) => {
    if (darkMode) {
      ...
      switch (status) {
        case 'pending': return 'bg-[#00001a]/15 text-[#00001a]'
        case 'approved': return 'bg-[#00001a]/10 text-[#00001a]'
        case 'rejected': return 'bg-[#00001a]/20 text-[#00001a]'
  ...
  const getLevelColor = (level) => {
    if (darkMode) {
      ...
      switch (level) {
        case 'Beginner': return 'bg-[#00001a]/10 text-[#00001a]'
        case 'Intermediate': return 'bg-[#00001a]/15 text-[#00001a]'
        case 'Advanced': return 'bg-[#00001a]/20 text-[#00001a]'
        default: return 'bg-[#00001a]/5 text-[#00001a]/70'
      }
    }
  }
